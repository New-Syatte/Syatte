  ...
  return (
    <>
      ...
      <div className="flex w-full h-[960px] p-[140px] relative overflow-hidden">
        <div className="flex w-[300px] absolute top-[50px] right-[-150px]  rotate-[-10deg]">
          <img
      ...
      {/* 제품 특징 */}
      <div className="flex flex-col w-full h-auto mt-[100px] mb-[240px] relative">
        <div className="flex w-[350px] absolute top-0 left-[-150px] rotate-[15deg]">
          <img
