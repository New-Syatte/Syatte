  ...
  return (
    <RouteComplete>
      ...
      <div className={"flex flex-col justify-center items-center pt-24 pb-14"}>
        ...
        <span
          className={
            "mt-4 text-center text-black text-6xl font-bold font-helvetica"
          }
        >
          패키지 교육 과정
        </span>
        <span
          className={
            "mt-7 w-[851px] text-center text-black text-lg font-normal font-helvetica leading-[30px]"
          }
        >
      ...
      <div>
        <div className={"mt-44 flex flex-col items-center pb-12"}>
          ...
          <span
            className={
              "text-center text-black text-6xl font-bold font-helvetica"
            }
          >
            단과 교육
          </span>
