...
const StatusProgress = () => {
  ...
  return (
    <div className="w-full grid grid-cols-[2fr_1fr_2fr_1fr_2fr_1fr_2fr] sm:grid-cols-[3fr_1fr_3fr_1fr_3fr_1fr_3fr] items-center gap-2 px-4">
      {statusArray.map((status, index) => (
        <div key={`status-group-${status}`} className="contents">
          <div className="col-span-1 flex flex-col justify-center items-center relative font-medium text-lg bg-bgWhiteSmoke w-full sm:h-[50px] h-[120px] rounded-md border border-lightGray p-3 sm:p-1">
            <p className="mb-2.5 sm:mb-0 text-[22px] sm:text-[10px] font-bold leading-4 whitespace-pre text-center">
          ...
          {index < statusArray.length - 1 && (
            <div className="col-span-1 flex justify-center items-center w-full status-chevron">
