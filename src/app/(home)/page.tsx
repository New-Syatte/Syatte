        ...
        <div className="w-full h-[1100px] flex flex-col items-center">
          <div className="w-[85%]">
            ...
            <p className="text-lg pt-9 mb-20">
              ...
              기법을 포페인팅 경험에 제공하며 <br /> 고급 기술과 창의성이 결합된
              포페인팅은 독특한 분위기를 조성하여 인상적인 결과물을 선사합니다.
            </p>
            ...
            <div className="w-full h-[304px] flex border border-[#ececec] mb-[10px]">
              ...
              <div className="w-full h-full p-14">
                ...
                <p className="text-lg mb-8">
                  고급 특수 페인트 및 금속 마감 솔루션 전문 제조업체로, 독특하고
                  혁신적인 디자인을 위한 제품을 선보이며 세계적인 <br /> 평가를
                  받고 있습니다. 미국을 중심으로 전 세계의 건축가, 디자이너,
                  예술가들에게 폭넓게 사용되고 있습니다.
                </p>
