...
const GreetingClient = () => {
  ...
  return (
    <div className="relative z-30 flex flex-col items-center w-full p-64">
      <div className="h-[750px] w-full flex gap-60 justify-between">
      ...
      <div className="w-full h-[342px] bg-bgGray border border-[#e4e4e4] relative rounded-[4px] mb-32">
        <Image
        ...
        <div className="flex p-10 pr-28 justify-start items-center w-full h-full gap-60">
          <div className="flex gap-9 justify-start items-start h-full">
            ...
            <ul className="text-lg flex flex-col gap-2">
              <li>1998 수채화 교육장 개설</li>
              <li>2002 칼헤인즈 마블페인팅 수료</li>
              <li>2009 미국 모던마스터즈 어플리케이터 수료</li>
              <li>2010 미국 모던마스터즈 어플리케이터 수료</li>
              <li>2010 미국 어메리칸클레이 어플리케이터 수료</li>
              <li>2011 미국 모던마스터즈 어플리케이터 수료</li>
              <li>2013 미국 모던마스터즈 어드밴스드 수료</li>
            </ul>
          </div>
          <div className="flex gap-9 justify-start items-start h-full">
            <div className="bg-[#9BB5B5] w-[6px] h-full" />
            <ul className="text-lg flex flex-col gap-2">
              <li>2013 스페셜페인팅 민간자격등록(2013-1086)</li>
              <li>2018 호주 포터스페인트 디테일스킬 수료</li>
              <li>2018 포페인팅 민간자격 명칭변경(2013-1086)</li>
              <li>2021 피엘핀켈스테인 우드/마블 페인팅 수료</li>
              <li>2023 독일 마이다스메탈 어플리케이터 수료</li>
              <li>2023 이태리 노바컬러 어드밴스드클래스 수료</li>
            </ul>
          </div>
        </div>
      </div>
      <div className="flex flex-col justify-start w-full mb-24">
      ...
      <div className="flex flex-col justify-start w-full">
        ...
        <div className="flex w-[768px] flex-wrap gap-3">
          {medias.map((media, index) => (
            <div className="relative w-[244px] h-[166px]" key={index}>
              <Image
                key={index}
                src={media}
                alt="media"
